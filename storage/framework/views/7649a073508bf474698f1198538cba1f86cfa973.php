...
<div class="container text-center">
     <div class="col-md-12">
       ...
       <div class="card">
         <div class="card-body">
           <div class="">
             <form class="" action="<?php echo e(route('orders.store')); ?>" method="post">
               <?php echo csrf_field(); ?>
               <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shopApp\resources\views/orders/create.blade.php ENDPATH**/ ?>